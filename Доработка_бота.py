...
async def get_buying_list(message):
    with open('png/1.png', 'rb') as img:
        await message.answer_photo(img, 'Название: Product1 | Описание: продукт1 | Цена: 100')
    with open('png/1.png', 'rb') as img:
        await message.answer_photo(img, 'Название: Product2 | Описание: продукт2 | Цена: 200')
    with open('png/1.png', 'rb') as img:
        await message.answer_photo(img, 'Название: Product3 | Описание: продукт3 | Цена: 300')
    with open('png/1.png', 'rb') as img:
        await message.answer_photo(img, 'Название: Product4 | Описание: продукт4 | Цена: 400')
